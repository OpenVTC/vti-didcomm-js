 ...
 *
 * The ephemeral, sender, and recipient keys must all be on the same
 * curve (`crv`). DIDComm uses X25519 by default; P-256 is also
 * supported (NIST ECDH, RFC 7518 §4.6).
 *
 * @param {Object} args
 * @param {Uint8Array} args.ephemeralPrivate - 32-byte scalar
 * @param {Uint8Array} args.senderPrivate    - 32-byte scalar
 * @param {Uint8Array} args.recipientPublic  - curve-appropriate public key
 ...
 *
 * @param {Object} args
 * @param {Uint8Array} args.recipientPrivate - 32-byte scalar
 * @param {Uint8Array} args.ephemeralPublic  - curve-appropriate public key
 * @param {Uint8Array} args.senderPublic     - curve-appropriate public key
